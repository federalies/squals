 ...
 * @typedef paramSSRule
 * @type {Object}
 * @property {?string} algo - asd.
 * @property {?string} keyID - asd.
 */
 ...
 * @property {?string} ServerSideEncryptionByDefault.KMSMasterKeyID - The AWS KMS master key ID used for the SSE-KMS encryption.
